...
int getFrontCorner(int num)
{
	//num对应相机拍到的四张图的序号，对应不同的num，后面的计算也不同
	//Load raw image
	const char* path0 = "D:\\huangshun\\Documents\\Projects\\border positioning\\images\\front\\front 1.bmp";
